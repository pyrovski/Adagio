...
/** NOTE:
    There are FORTRAN wrappers for all of the functions below.  The only
    difference is that all parameters are pass-by-reference pointers, since
    that's just how FORTRAN rolls.
 **/
